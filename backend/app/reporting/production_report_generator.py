...
class ReportConfig:
    ...
    def from_env(cls) -> 'ReportConfig':
        ...
        timezone_str = get_required_str_env('TIMEZONE') or 'Asia/Singapore'
        if timezone_str == 'Asia/Singapore' and os.getenv('TIMEZONE') is None:
            logger.warning("TIMEZONE not set in .env, using 'Asia/Singapore'")
